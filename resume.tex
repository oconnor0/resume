...
\begin{itemize}
	...
	\begin{itemize*}
		\item Investigated different ticket sales systems: open source and writing our own.
		\item Took 2 months to modify an existing open source ticketing system.
		\item The ticketing system was deployed to production and used to sell thousands of tickets for multiple shows for Christmas and Easter events.
	\end{itemize*}
